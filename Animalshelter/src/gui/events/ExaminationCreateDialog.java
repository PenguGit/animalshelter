...
public class ExaminationCreateDialog extends JDialog implements GUIConstants {
	 ...
	 */
	public ExaminationCreateDialog(AnimalDTO animal, Frame owner, String title, boolean modal) {
