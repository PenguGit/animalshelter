...
public class ExaminationDisplayDialog extends JDialog implements GUIConstants {
	 ...
	 */
	public ExaminationDisplayDialog(ExaminationDTO examination, Frame owner, String title, boolean modal) {
	...
	private void initializeComponents() {;
		...
		vetLabel = new ShelterLabel();
		vetLabel.setPreferredSize(new Dimension(250, 30));
        ...
        addLabelAndField(gbc, "Arzt:", vetLabel, 6, 1);
	...
	private void fillForm() {
		titleTextField.setText(examination.getTitle());
		descriptionTextArea.setText(examination.getDescription());
		dateField.setDate(examination.getDate());
		animalLabel.setText(examination.getAnimal().getName());
		vetLabel.setText(examination.getVet().getLastName() + ", " + examination.getVet().getFirstName());
	}
}
